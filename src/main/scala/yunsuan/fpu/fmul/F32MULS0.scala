...
class F32MULS0ToS1Bundle(val totalWidth: Int) extends Bundle with FloatParams {
...
class F32MULS1ToS2Bundle(val totalWidth: Int) extends Bundle with FloatParams {
...
class F32MULS0(val totalWidth: Int, val version: Int = 0) extends Module with FloatParams {
  ...
  val fp_a_is_nan = fp_a_exp_all_one & fp_a_raw_frac_not_zero
  val fp_b_is_nan = fp_b_exp_all_one & fp_b_raw_frac_not_zero
  val fp_a_is_snan = fp_a_is_nan & !fp_a_raw_frac.head(1)
  val fp_b_is_snan = fp_b_is_nan & !fp_b_raw_frac.head(1)
  val fp_a_is_zero = fp_a_exp_is_zero & !fp_a_raw_frac_not_zero
  val fp_b_is_zero = fp_b_exp_is_zero & !fp_b_raw_frac_not_zero
  val fp_a_is_inf = fp_a_exp_all_one & !fp_a_raw_frac_not_zero
  val fp_b_is_inf = fp_b_exp_all_one & !fp_b_raw_frac_not_zero
  ...
  val out_expc = Mux(expc_signed_is_negtive, 0.U, Mux(expc_signed_is_overflow, Fill(exponentWidth, 1.U), expc_signed(exponentWidth - 1, 0)))
  val lzd_a_b = Mux(fp_a_exp_is_zero, fp_a_frac_lzd, fp_b_frac_lzd)
